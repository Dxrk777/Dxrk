...
_MVP_SKILLS = [
    ...
    Skill(SkillID.VOICE_BUILDER, "voice-builder", _CAT_MEDIA, _PRIORITY_P2),
    Skill(SkillID.NEWSLETTER_VOICE, "newsletter-voice", _CAT_MEDIA, _PRIORITY_P2),
    Skill(SkillID.PROFILE_OPTIMIZER, "profile-optimizer", _CAT_MEDIA, _PRIORITY_P2),
    Skill(SkillID.POST_WRITER, "post-writer", _CAT_MEDIA, _PRIORITY_P2),
    Skill(SkillID.GRAPHIC_DESIGNER, "graphic-designer", _CAT_MEDIA, _PRIORITY_P2),
    Skill(SkillID.POST_SCORER, "post-scorer", _CAT_MEDIA, _PRIORITY_P2),
    Skill(SkillID.REELS_SCRIPTING, "reels-scripting", _CAT_MEDIA, _PRIORITY_P2),
    Skill(SkillID.YOUTUBE_THUMBNAIL, "youtube-thumbnail", _CAT_MEDIA, _PRIORITY_P2),
    Skill(SkillID.PINNED_COMMENT, "pinned-comment", _CAT_MEDIA, _PRIORITY_P2),
    Skill(SkillID.HOOK_GENERATOR, "hook-generator", _CAT_MEDIA, _PRIORITY_P2),
    Skill(SkillID.POST_FORMATTER, "post-formatter", _CAT_MEDIA, _PRIORITY_P2),
    Skill(SkillID.CONTENT_MATRIX, "content-matrix", _CAT_MEDIA, _PRIORITY_P2),
    Skill(SkillID.NICHE_RESEARCH, "niche-research", _CAT_MEDIA, _PRIORITY_P2),
    Skill(SkillID.GEMINI_INFOGRAPHIC, "gemini-infographic", _CAT_MEDIA, _PRIORITY_P2),
    Skill(SkillID.GEMINI_CAROUSEL, "gemini-carousel", _CAT_MEDIA, _PRIORITY_P2),
    Skill(SkillID.QUOTE_POST, "quote-post", _CAT_MEDIA, _PRIORITY_P2),
    Skill(SkillID.ANALYTICS_DASHBOARD, "analytics-dashboard", _CAT_MEDIA, _PRIORITY_P2),
