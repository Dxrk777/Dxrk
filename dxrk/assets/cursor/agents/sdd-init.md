...
description: >
  ...
  "iniciar sdd", or wants to bootstrap SDD persistence (memory, openspec, or hybrid) for the
...
2. Initialize the persistence backend (memory, openspec, or hybrid — per user preference)
